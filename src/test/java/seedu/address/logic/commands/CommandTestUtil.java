...
public class CommandTestUtil {
    ...
    public static final String PHONE_DESC_AMY = " " + PREFIX_RATING + VALID_PHONE_AMY;
    public static final String PHONE_DESC_BOB = " " + PREFIX_RATING + VALID_PHONE_BOB;
    ...
    public static final String INVALID_PHONE_DESC = " " + PREFIX_RATING + "911a"; // 'a' not allowed in phones
    ...
    public static final EditCommand.EditStudySpotDescriptor DESC_AMY;
    public static final EditCommand.EditStudySpotDescriptor DESC_BOB;

    static {
        DESC_AMY = new EditStudySpotDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditStudySpotDescriptorBuilder().withName(VALID_NAME_BOB)
     ...
     * - the study tracker, filtered person list and selected person in {@code actualModel} remain unchanged
     */
    ...
    public static void showStudySpotAtIndex(Model model, Index targetIndex) {
        ...
        StudySpot person = model.getFilteredStudySpotList().get(targetIndex.getZeroBased());
